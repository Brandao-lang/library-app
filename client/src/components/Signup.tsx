...
const Signup: React.FC = () => {
    ...
    const submitHandler = async(e:any) => {
        ...
        if (input.password !== input.confirmPassword) {
            setSignupError(true)
            return
        } else if (input.username === '' || input.password === '' || input.email === '' || input.password === '') {
        ...
        <>
            ...
            <div className='sign-up-container'>
                ...
                <form className='signup-form' onSubmit={submitHandler}>
                    ...
                    <Alert className={missingFieldError ? 'login-alert-show' : 'login-alert-hide'} variant='danger'>All fields are required</Alert>
